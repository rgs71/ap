...
* Wir können uns Problemlösen als Prozeß vorstellen, bei dem man bestimmte Eingaben annimmt (die unser Problem beschreiben) und daraus eine Ausgabe generiert (die Lösung des Problems). Der schwarze Kasten, ist der Teil, über den man in verschiedenen Kontexten im Informatikunterricht spricht.
